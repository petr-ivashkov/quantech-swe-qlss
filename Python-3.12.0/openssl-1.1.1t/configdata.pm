...
our %config = (
  ...
  CFLAGS => [ "-Wall -O3" ],
  CPPDEFINES => [  ],
  CPPFLAGS => [ "-I/cluster/home/zbinczyk/openssl/include" ],
  CPPINCLUDES => [  ],
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LDFLAGS => [ "-L/cluster/home/zbinczyk/openssl/lib" ],
  LDLIBS => [  ],
  PERL => "/usr/bin/perl",
  RANLIB => "ranlib",
  RC => "windres",
  ...
  prefix => "/cluster/home/zbinczyk/openssl",
  processor => "",
